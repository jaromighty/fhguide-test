                    ...
                    <div className="flex items-center justify-between h-16">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-2">
                                    <div className="relative" onMouseEnter={() => setIntroIsOpen(true)} onMouseLeave={() => setIntroIsOpen(false)}>
                                        ...
                                        >
                                            <div className="absolute -ml-0 pt-2 transform px-2 w-screen max-w-xl sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/3">
                                                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                                    <div className="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-6">
                                                        <Link to="/get-started" className="-m-3 p-3 flex items-start rounded-lg hover:bg-cyan-100 transition ease-in-out duration-150">
                                                            <svg className="flex-shrink-0 w-6 h-6 text-cyan-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div className="ml-4">
                                                                ...
                                                                <p className="mt-1 text-sm text-gray-500">
                                                                    Start on your family history journey.
                                                                </p>
                                                            </div>
                                                        </Link>
                                                        <div className="md:ml-10 md:grid md:grid-cols-3 md:gap-4">
                                                            <div>
                                                                <h3 className="text-sm tracking-widest font-medium text-gray-500 uppercase">Introduction</h3>
                                                                <ul className="mt-3 space-y-2">
                                                                    <li className="text-base truncate">
                                                                        <Link to="#" className="font-base text-gray-900 hover:text-cyan-700 transition ease-in-out duration-150">
                                                                            15 Minutes
                                                                        </Link>
                                                                    </li>
                                                            ...
                                                            <div>
                                                                <h3 className="text-sm tracking-widest font-medium text-gray-500 uppercase">Beginners</h3>
                                                                <ul className="mt-3 space-y-2">
                                                                    <li className="text-base truncate">
                                                                        <Link to="#" className="font-base text-gray-900 hover:text-cyan-700 transition ease-in-out duration-150">
                                                                            For Beginners
                                                            ...
                                                            <div>
                                                                <h3 className="text-sm tracking-widest font-medium text-gray-500 uppercase">Guides</h3>
                                                                <ul className="mt-3 space-y-2">
                                                                    <li className="text-base truncate">
                                                                        <Link to="#" className="font-base text-gray-900 hover:text-cyan-700 transition ease-in-out duration-150">
                                                                            Learning System
                                    ...
                                    <div className="relative" onMouseEnter={() => setPartnersIsOpen(true)} onMouseLeave={() => setPartnersIsOpen(false)}>
                                        <button className="px-3 py-2 group rounded-md text-gray-500 inline-flex items-center text-sm font-medium hover:bg-gray-200 hover:bg-opacity-75 focus:outline-none focus:bg-gray-700">
                                            <span>Partners</span>
                                            <svg className="ml-2 h-5 w-5 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                        ...
                        <div className="hidden md:block text-right">
                            <span className="inline-flex rounded-md shadow-md ring-1 ring-black ring-opacity-5">
                                <a href="#" className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-cyan-600 bg-white hover:bg-gray-50">
                                    Log in to Tracker
