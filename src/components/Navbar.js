...
import logo from '../img/fh-guide-indigo-300.svg'
                                ...
                                <div className="hidden md:block">
                                    <div className="ml-10 flex items-baseline space-x-2">
                                        <div className="relative">
                                            <button className="px-3 py-2 group rounded-md text-white inline-flex items-center text-sm font-medium hover:bg-indigo-500 hover:bg-opacity-75 focus:outline-none focus:bg-indigo-700">
                                                <span>Intro</span>
                                                <svg className="ml-2 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            ...
                                            <div className="hidden absolute -ml-0 pt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/3">
                                                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                                    <div className="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                                        <Link to="#">
                                                            <a className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                                                <svg class="flex-shrink-0 w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="hidden absolute -ml-4 pt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                                                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                                    <div className="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                                        <Link to="#">
                                                            <a className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                                                <svg className="flex-shrink-0 h-6 w-6 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" stroke="none" aria-hidden="true">
                                                        ...
                                                        <Link to="#">
                                                            <a className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                                                <svg className="flex-shrink-0 h-6 w-6 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" stroke="currentColor" aria-hidden="true">
